...
public class Microhondas extends JFrame {
	...
	public Microhondas() {
		...
		// Creo un panel y llamo al metodo panelNumero() para crearme el
		// gridLayout con los botones
		JPanel numeros = panelNumerico();

		/*
		 * 1-Creo panel elem como un BorderLayout 
		 * 2-Añado el textfield al norte y el panel numero al este, ya que si lo coloco al sur crea un vacio
		 * intermedio 3-Añado panel elem al Frame
		 */
